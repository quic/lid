...
class Location_Finder:
    ...
    def main_process(self, license_file, input_src_file):
        ...
        # 4. Find the window with maximum scores.
        max_score = max(similarity_scores)
        max_index = [i for i, j in enumerate(similarity_scores) if j == max_score]

        # print 'max score:', max_score
        # print 'similairty scores', similarity_scores
        ...
        if max_score > 0.02: # 0.02 is just randomly chosen low number
